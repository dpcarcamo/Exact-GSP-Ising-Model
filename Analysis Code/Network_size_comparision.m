...
%save('NetworkSizeComparison_FullRange.mat', "Data")
% 
...
% function [JTreeRand, hTreeRand, H] = Random_Tree(datamean,datacorr_pseudo)
% 
% 
%     numSpins = size(datacorr_pseudo,1);
%     spins = 1:numSpins;
% 
%     JTreeRand = zeros(numSpins,numSpins);
% 
